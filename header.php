...
<html lang="en">
	<head>
		...
		<link rel="shortcut icon" href="<?php echo theme_url('/public/img/favicon.png'); ?>">
		...
		<script src="<?php echo theme_url('/public/js/main.js'); ?>"></script>
	    ...
	    <meta property="og:image" content="<?php echo theme_url('/public/img/og_image.gif'); ?>">
